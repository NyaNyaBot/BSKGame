#!/bin/bash
# CCGS Hook: Log subagent invocations for audit trail
# Cursor event: subagentStart
...
echo "$TIMESTAMP | Agent invoked: $AGENT_TYPE" >> "$SESSION_LOG_DIR/agent-audit.log" 2>/dev/null
