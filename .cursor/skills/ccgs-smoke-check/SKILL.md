...
3. **Engine detection**: read `.cursor/skills/ccgs-studio/references/docs/technical-preferences.md` and
...
"Engine not configured in `.cursor/skills/ccgs-studio/references/docs/technical-preferences.md`. Run
