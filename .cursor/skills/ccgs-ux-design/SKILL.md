...
user-invocable: true
allowed-tools: Read, Glob, Grep, Write, Edit, AskQuestion, Task
agent: ux-designer
---
...
Read `.cursor/skills/ccgs-studio/references/docs/technical-preferences.md` and extract the `## Input & Platform`
...
Use `AskQuestion` to surface any open questions on accessibility tier:
