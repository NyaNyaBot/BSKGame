...
Before generating the Go/No-Go recommendation, spawn `producer` via Task using gate **PR-MILESTONE** (`.cursor/skills/ccgs-studio/references/docs/director-gates.md`).
