...
Spawn the **primary engine specialist** in parallel (from `.cursor/skills/ccgs-studio/references/docs/technical-preferences.md` Engine Specialists) to validate the integration approach:
