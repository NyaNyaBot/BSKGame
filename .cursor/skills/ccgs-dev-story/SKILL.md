...
user-invocable: true
allowed-tools: Read, Glob, Grep, Write, Bash, Task, AskQuestion
---
...
If they differ, use `AskQuestion` before proceeding:
...
### Engine reference
Read `.cursor/skills/ccgs-studio/references/docs/technical-preferences.md`:
...
Read the `Engine Specialists` section of `.cursor/skills/ccgs-studio/references/docs/technical-preferences.md`
