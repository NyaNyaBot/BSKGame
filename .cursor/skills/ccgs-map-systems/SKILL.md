...
user-invocable: true
allowed-tools: Read, Glob, Grep, Write, Edit, AskQuestion, TodoWrite, Task
---
...
**After dependency mapping is approved, spawn `technical-director` via Task using gate TD-SYSTEM-BOUNDARY (`.cursor/skills/ccgs-studio/references/docs/director-gates.md`) before proceeding to priority assignment.**
...
**After priorities are approved, spawn `producer` via Task using gate PR-SCOPE (`.cursor/skills/ccgs-studio/references/docs/director-gates.md`) before writing the index.**
...
Using the template at `.cursor/skills/ccgs-studio/references/templates/systems-index.md`, populate the
...
**After the systems index is written, spawn `creative-director` via Task using gate CD-SYSTEMS (`.cursor/skills/ccgs-studio/references/docs/director-gates.md`).**
