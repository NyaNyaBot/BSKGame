...
Validates `.cursor/skills/ccgs-*/SKILL.md` files for structural compliance and
...
- `static all` → run 7 structural checks on all skills (Glob `.cursor/skills/ccgs-*/SKILL.md`)
...
Glob `.cursor/skills/ccgs-*/SKILL.md` to get the complete list of skills.
