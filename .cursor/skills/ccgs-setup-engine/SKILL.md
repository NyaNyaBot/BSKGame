...
user-invocable: true
allowed-tools: Read, Glob, Grep, Write, Edit, WebSearch, WebFetch, Task, AskQuestion
---
...
After updating CLAUDE.md, create or update `.cursor/skills/ccgs-studio/references/docs/technical-preferences.md` with
...
### Remaining Sections
- **Performance Budgets**: Use `AskQuestion`:
