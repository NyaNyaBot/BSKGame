...
user-invocable: true
allowed-tools: Read, Glob, Grep, Bash, Edit, AskQuestion, Task
---
...
After completing the deviation checks in Phase 4, spawn `qa-lead` via Task using gate **QL-TEST-COVERAGE** (`.cursor/skills/ccgs-studio/references/docs/director-gates.md`).
...
Spawn `lead-programmer` via Task using gate **LP-CODE-REVIEW** (`.cursor/skills/ccgs-studio/references/docs/director-gates.md`).
