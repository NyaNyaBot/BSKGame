...
in this skill — apply the check pattern from `.cursor/skills/ccgs-studio/references/docs/director-gates.md`
...
After decomposing all stories (Step 4 complete) but before presenting them for write approval, spawn `qa-lead` via Task using gate **QL-STORY-READY** (`.cursor/skills/ccgs-studio/references/docs/director-gates.md`).
