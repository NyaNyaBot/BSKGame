...
user-invocable: true
allowed-tools: Read, Glob, Grep, Write, Bash, AskQuestion, Task
...
3. `.cursor/skills/ccgs-studio/references/docs/technical-preferences.md` — naming conventions, performance budgets,
...
Apply gate **TD-ARCHITECTURE** (`.cursor/skills/ccgs-studio/references/docs/director-gates.md`) as a self-review. Check all four criteria from that gate definition against the completed document.
...
**Step 2 — Spawn `lead-programmer` via Task using gate LP-FEASIBILITY (`.cursor/skills/ccgs-studio/references/docs/director-gates.md`):**
...
Use `AskQuestion` — "Technical Director and Lead Programmer have reviewed the architecture. How would you like to proceed?"
