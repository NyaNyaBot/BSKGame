...
Read `.cursor/skills/ccgs-studio/references/docs/workflow-catalog.yaml`. This is the authoritative list of all
...
After reading the catalog, Glob `.cursor/skills/ccgs-*/SKILL.md` to get the full list
