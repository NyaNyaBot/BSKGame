...
user-invocable: true
allowed-tools: Read, Glob, Grep, Bash, Write, Task, AskQuestion
model: gpt-5.5
---
...
- [ ] Technical preferences configured (`.cursor/skills/ccgs-studio/references/docs/technical-preferences.md` populated)
...
Before generating the final verdict, spawn all four directors as **parallel subagents** via Task using the parallel gate protocol from `.cursor/skills/ccgs-studio/references/docs/director-gates.md`. Issue all four Task calls simultaneously — do not wait for one before starting the next.

**Spawn in parallel:**

1. **`creative-director`** — gate **CD-PHASE-GATE** (`.cursor/skills/ccgs-studio/references/docs/director-gates.md`)
2. **`technical-director`** — gate **TD-PHASE-GATE** (`.cursor/skills/ccgs-studio/references/docs/director-gates.md`)
3. **`producer`** — gate **PR-PHASE-GATE** (`.cursor/skills/ccgs-studio/references/docs/director-gates.md`)
4. **`art-director`** — gate **AD-PHASE-GATE** (`.cursor/skills/ccgs-studio/references/docs/director-gates.md`)
...
- **No accessibility requirements doc?** → Use `AskQuestion` to offer to create it now:
  ...
  - If "Create it now": use a second `AskQuestion` to ask for the tier:
  ...
  - Then write `design/accessibility-requirements.md` using the template at `.cursor/skills/ccgs-studio/references/templates/accessibility-requirements.md`, filling in the chosen tier. Confirm: "May I write `design/accessibility-requirements.md`?"
