...
Verify `.cursor/skills/ccgs-[name]/SKILL.md` exists. If not, stop with:
...
Read the full skill file at `.cursor/skills/ccgs-[name]/SKILL.md`.
...
Ask: "May I write this improved version to `.cursor/skills/ccgs-[name]/SKILL.md`?"
...
Write the improved skill to `.cursor/skills/ccgs-[name]/SKILL.md`.
...
Ask: "May I revert `.cursor/skills/ccgs-[name]/SKILL.md` using git checkout?"
If yes: run `git checkout -- .cursor/skills/ccgs-[name]/SKILL.md`
