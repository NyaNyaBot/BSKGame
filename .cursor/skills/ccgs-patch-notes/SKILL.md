...
1. Check `.cursor/skills/ccgs-studio/references/docs/technical-preferences.md` for any "tone", "voice", or "style"
   fields or sections.
...
1. Glob for `docs/patch-notes-template.md` and `.cursor/skills/ccgs-studio/references/templates/patch-notes-template.md`.
