...
- `.cursor/skills/ccgs-studio/references/docs/technical-preferences.md` — engine configured?
...
Read `.cursor/skills/ccgs-studio/references/docs/technical-preferences.md`. Check each field for `[TO BE CONFIGURED]`:
